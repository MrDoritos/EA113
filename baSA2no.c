...
//1K0907115P__0020.sgo (not working quite yet)
int SA2[] = {0x68, 0x05, 0x81, 0x4a, 0x05, 0x87, 0x5f, 0xbd, 0x5d, 0xbd, 0x49, 0x4c, 0x02, 0x00, 0x00, 0x11, 0x06};
...
while(1)
{
	...
	if(DEBUG_LEVEL >= 1)printf("CURRENT SEED = %08lx at pos %i\n", v11, v3);
}
